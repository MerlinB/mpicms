...
The Wagtail API module exposes a public, read only, JSON-formatted API.
...
.. note::
    ...
    The maximum value for the ``?limit`` parameter is 50 by deafult. This can be
